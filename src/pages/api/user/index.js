...
import Asset from "@/db/models/Asset"; // Angenommen, Sie haben dieses Modell
  ...
  switch (method) {
    ...
    case "POST":
      ...
      try {
        ...
        await newAsset.save();
        await User.findByIdAndUpdate(request.body.userId, { $push: { assets: newAsset._id } }); // Angenommen, userId wird im Body gesendet
